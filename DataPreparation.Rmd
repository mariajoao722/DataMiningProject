...
## Feature engineering
//todo: trans_dev_transform have the column statusAccount wrong
...
client_transform <- client_transform %>%
  ...
  mutate(genderF = if_else(month > 50, 1, 0)) %>%
...
\\ diferença entre dimensionality redution and feature scaling (data Transformation) 
````{r}
